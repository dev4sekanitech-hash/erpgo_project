...
class PermissionRoleSeeder extends Seeder
{
    public function run()
    {
        ...
        $permissions = [
            ...
            // Starrlight Module
            ['name' => 'manage-starrlight', 'module' => 'starrlight', 'label' => 'Manage Starrlight'],
            ['name' => 'manage-starrlight-caregivers', 'module' => 'starrlight', 'label' => 'Manage Starrlight Caregivers'],
            ['name' => 'manage-starrlight-jobs', 'module' => 'starrlight', 'label' => 'Manage Starrlight Jobs'],
            ['name' => 'manage-starrlight-applications', 'module' => 'starrlight', 'label' => 'Manage Starrlight Applications'],
            ['name' => 'manage-starrlight-staff-requests', 'module' => 'starrlight', 'label' => 'Manage Starrlight Staff Requests'],
            ['name' => 'manage-starrlight-careers', 'module' => 'starrlight', 'label' => 'Manage Starrlight Careers'],
            ['name' => 'manage-starrlight-contacts', 'module' => 'starrlight', 'label' => 'Manage Starrlight Contacts'],
        ];
        ...
        $roles = [
            'superadmin' => [
                ...
                'permissions' => [
                    ...
                    'manage-starrlight-applications',
                    'manage-starrlight-staff-requests',
                    'manage-starrlight-careers',
